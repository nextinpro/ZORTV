...
.method constructor <init>(Landroid/content/Intent;Landroid/content/BroadcastReceiver$PendingResult;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-boolean v0, p0, Lbpo;->c:Z

    iput-object p1, p0, Lbpo;->a:Landroid/content/Intent;

    iput-object p2, p0, Lbpo;->b:Landroid/content/BroadcastReceiver$PendingResult;

    new-instance p2, Lbpp;

    invoke-direct {p2, p0, p1}, Lbpp;-><init>(Lbpo;Landroid/content/Intent;)V
    ...
    iput-object p1, p0, Lbpo;->d:Ljava/util/concurrent/ScheduledFuture;
...
.method final declared-synchronized a()V
    ...
    :try_start_0
    iget-boolean v0, p0, Lbpo;->c:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lbpo;->b:Landroid/content/BroadcastReceiver$PendingResult;

    invoke-virtual {v0}, Landroid/content/BroadcastReceiver$PendingResult;->finish()V

    iget-object v0, p0, Lbpo;->d:Ljava/util/concurrent/ScheduledFuture;
