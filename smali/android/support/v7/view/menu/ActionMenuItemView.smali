...
# static fields
.field private static final e:Ljava/lang/String; = "ActionMenuItemView"
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->i:Z

    .line 74
    sget-object v1, Lll$l;->ActionMenuItemView:[I
    ...
    .line 76
    sget p2, Lll$l;->ActionMenuItemView_android_minWidth:I

    invoke-virtual {p1, p2, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p2

    iput p2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->k:I
...
.method private g()V
    ...
    .line 188
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1

    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lnz;

    .line 189
    invoke-virtual {v2}, Lnz;->n()Z
    ...
    .line 191
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->f:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lnz;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lnz;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lnz;->getTooltipText()Ljava/lang/CharSequence;
    ...
    .line 206
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lnz;

    invoke-virtual {v0}, Lnz;->getTitle()Ljava/lang/CharSequence;

    move-result-object v1

    :goto_4
    invoke-static {p0, v1}, Lrd;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    .line 208
    :cond_6
    invoke-static {p0, v2}, Lrd;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public a(Lnz;I)V
    ...
    .line 123
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lnz;
    ...
    .line 126
    invoke-virtual {p1, p0}, Lnz;->a(Lof$a;)Ljava/lang/CharSequence;
    ...
    .line 132
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Lpy;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Lpy;
...
.method public d()Z
    ...
    invoke-virtual {v0}, Lnz;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 149
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Lnw$b;
    ...
    invoke-interface {p1, v0}, Lnw$b;->a(Lnz;)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    .line 91
    invoke-super {p0, p1}, Lpn;->onConfigurationChanged(Landroid/content/res/Configuration;)V
...
.method protected onMeasure(II)V
    ...
    .line 270
    invoke-super {p0, v1, v2, v3, v4}, Lpn;->setPadding(IIII)V
    ...
    :cond_1
    iget p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->k:I
    ...
    .line 288
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/graphics/drawable/Drawable;
    ...
    .line 292
    iget-object p2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/graphics/drawable/Drawable;
    ...
    invoke-super {p0, p1, p2, v0, v1}, Lpn;->setPadding(IIII)V
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 332
    invoke-super {p0, p1}, Lpn;->onRestoreInstanceState(Landroid/os/Parcelable;)V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lnz;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Lpy;
    ...
    .line 144
    :cond_0
    invoke-super {p0, p1}, Lpn;->onTouchEvent(Landroid/view/MotionEvent;)Z
...
.method public setExpandedFormat(Z)V
    ...
    .line 178
    iget-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->j:Z
    ...
    .line 180
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->b:Lnz;
...
.method public setItemInvoker(Lnw$b;)V
    .locals 0

    .line 155
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->c:Lnw$b;
...
.method public setPadding(IIII)V
    ...
    .line 113
    invoke-super {p0, p1, p2, p3, p4}, Lpn;->setPadding(IIII)V
