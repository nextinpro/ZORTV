...
.method static e(Landroid/support/v7/widget/RecyclerView$x;)I
    ...
    .line 12661
    invoke-virtual {p0}, Landroid/support/v7/widget/RecyclerView$x;->g()I
...
# virtual methods
.method public a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$x;)Landroid/support/v7/widget/RecyclerView$f$d;
    .locals 0
    ...
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/RecyclerView$f$d;->a(Landroid/support/v7/widget/RecyclerView$x;)Landroid/support/v7/widget/RecyclerView$f$d;
...
.method public a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$x;ILjava/util/List;)Landroid/support/v7/widget/RecyclerView$f$d;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public abstract a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$d;Landroid/support/v7/widget/RecyclerView$f$d;)Z
.end method

.method public abstract a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$d;Landroid/support/v7/widget/RecyclerView$f$d;)Z
.end method
...
.method public a(Landroid/support/v7/widget/RecyclerView$x;Ljava/util/List;)Z
    ...
    .line 12875
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/RecyclerView$f;->j(Landroid/support/v7/widget/RecyclerView$x;)Z
...
.method public abstract b(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$d;Landroid/support/v7/widget/RecyclerView$f$d;)Z
.end method
...
.method public abstract c(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$d;Landroid/support/v7/widget/RecyclerView$f$d;)Z
.end method
...
.method public final f(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/widget/RecyclerView$f$c;->a(Landroid/support/v7/widget/RecyclerView$x;)V
...
.method public final h(Landroid/support/v7/widget/RecyclerView$x;)V
    .locals 0

    .line 12781
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/RecyclerView$f;->i(Landroid/support/v7/widget/RecyclerView$x;)V
...
.method public final i()V
    ...
    check-cast v2, Landroid/support/v7/widget/RecyclerView$f$b;

    invoke-interface {v2}, Landroid/support/v7/widget/RecyclerView$f$b;->a()V
...
.method public i(Landroid/support/v7/widget/RecyclerView$x;)V
    .locals 0
