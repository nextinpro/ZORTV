...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->P:Ljava/lang/Runnable;
    ...
    sget-object v0, Lll$l;->Toolbar:[I
    ...
    .line 238
    sget p2, Lll$l;->Toolbar_titleTextAppearance:I

    invoke-virtual {p1, p2, v1}, Lrb;->g(II)I
    ...
    .line 239
    sget p2, Lll$l;->Toolbar_subtitleTextAppearance:I
    ...
    .line 240
    sget p2, Lll$l;->Toolbar_android_gravity:I

    iget p3, p0, Landroid/support/v7/widget/Toolbar;->y:I

    invoke-virtual {p1, p2, p3}, Lrb;->c(II)I
    ...
    .line 241
    sget p2, Lll$l;->Toolbar_buttonGravity:I
    ...
    .line 244
    sget p2, Lll$l;->Toolbar_titleMargin:I

    invoke-virtual {p1, p2, v1}, Lrb;->d(II)I

    move-result p2

    .line 245
    sget p3, Lll$l;->Toolbar_titleMargins:I

    invoke-virtual {p1, p3}, Lrb;->j(I)Z
    ...
    invoke-virtual {p1, p3, p2}, Lrb;->d(II)I
    ...
    .line 251
    sget p2, Lll$l;->Toolbar_titleMarginStart:I

    const/4 p3, -0x1

    invoke-virtual {p1, p2, p3}, Lrb;->d(II)I
    ...
    .line 256
    :cond_1
    sget p2, Lll$l;->Toolbar_titleMarginEnd:I
    ...
    .line 261
    :cond_2
    sget p2, Lll$l;->Toolbar_titleMarginTop:I
    ...
    .line 266
    :cond_3
    sget p2, Lll$l;->Toolbar_titleMarginBottom:I
    ...
    .line 272
    :cond_4
    sget p2, Lll$l;->Toolbar_maxButtonHeight:I

    invoke-virtual {p1, p2, p3}, Lrb;->e(II)I
    ...
    .line 274
    sget p2, Lll$l;->Toolbar_contentInsetStart:I
    ...
    .line 277
    sget v2, Lll$l;->Toolbar_contentInsetEnd:I

    .line 278
    invoke-virtual {p1, v2, v0}, Lrb;->d(II)I

    move-result v2

    .line 280
    sget v3, Lll$l;->Toolbar_contentInsetLeft:I

    .line 281
    invoke-virtual {p1, v3, v1}, Lrb;->e(II)I

    move-result v3

    .line 282
    sget v4, Lll$l;->Toolbar_contentInsetRight:I

    .line 283
    invoke-virtual {p1, v4, v1}, Lrb;->e(II)I
    ...
    .line 286
    iget-object v5, p0, Landroid/support/v7/widget/Toolbar;->v:Lqp;

    invoke-virtual {v5, v3, v4}, Lqp;->b(II)V
    ...
    .line 290
    :cond_5
    iget-object v3, p0, Landroid/support/v7/widget/Toolbar;->v:Lqp;

    invoke-virtual {v3, p2, v2}, Lqp;->a(II)V

    .line 293
    :cond_6
    sget p2, Lll$l;->Toolbar_contentInsetStartWithNavigation:I
    ...
    .line 295
    sget p2, Lll$l;->Toolbar_contentInsetEndWithActions:I
    ...
    .line 298
    sget p2, Lll$l;->Toolbar_collapseIcon:I

    invoke-virtual {p1, p2}, Lrb;->a(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->k:Landroid/graphics/drawable/Drawable;

    .line 299
    sget p2, Lll$l;->Toolbar_collapseContentDescription:I

    invoke-virtual {p1, p2}, Lrb;->d(I)Ljava/lang/CharSequence;

    move-result-object p2

    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->l:Ljava/lang/CharSequence;

    .line 301
    sget p2, Lll$l;->Toolbar_title:I
    ...
    .line 306
    :cond_7
    sget p2, Lll$l;->Toolbar_subtitle:I
    ...
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->m:Landroid/content/Context;

    .line 313
    sget p2, Lll$l;->Toolbar_popupTheme:I
    ...
    .line 315
    sget p2, Lll$l;->Toolbar_navigationIcon:I
    ...
    .line 319
    :cond_9
    sget p2, Lll$l;->Toolbar_navigationContentDescription:I
    ...
    .line 329
    :cond_b
    sget p2, Lll$l;->Toolbar_logoDescription:I
    ...
    .line 334
    :cond_c
    sget p2, Lll$l;->Toolbar_titleTextColor:I
    ...
    invoke-virtual {p1, p2, p3}, Lrb;->b(II)I
    ...
    .line 338
    :cond_d
    sget p2, Lll$l;->Toolbar_subtitleTextColor:I
...
.method private a(Landroid/view/View;Z)V
    ...
    .line 1402
    iget-object p2, p0, Landroid/support/v7/widget/Toolbar;->G:Ljava/util/ArrayList;
...
.method private a(Ljava/util/List;I)V
    ...
    .line 2020
    invoke-static {p2, v4}, Liq;->a(II)I
    ...
    .line 2029
    iget v2, v1, Landroid/support/v7/widget/Toolbar$b;->e:I
    ...
    .line 2038
    iget v4, v2, Landroid/support/v7/widget/Toolbar$b;->e:I
...
.method private b(I)I
    ...
    .line 2006
    iget p1, p0, Landroid/support/v7/widget/Toolbar;->y:I
...
.method private static d(Landroid/view/View;)Z
    ...
    iget p0, p0, Landroid/support/v7/widget/Toolbar$b;->e:I
...
.method private o()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActionMenuView;->d()Lnw;
    ...
    invoke-virtual {v0, v1, v2}, Lnw;->a(Loe;Landroid/content/Context;)V
...
.method private p()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->M:Loe$a;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->N:Lnw$a;

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/ActionMenuView;->a(Loe$a;Lnw$a;)V
...
.method private q()V
    ...
    sget v3, Lll$b;->toolbarNavigationButtonStyle:I

    invoke-direct {v0, v1, v2, v3}, Lpa;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method private s()Z
    ...
    .line 1555
    iget-boolean v0, p0, Landroid/support/v7/widget/Toolbar;->O:Z
...
.method private t()V
    ...
    .line 2167
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->v:Lqp;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->v:Lqp;
...
.method protected a(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/v7/widget/Toolbar$b;
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/widget/Toolbar$b;-><init>(Lkj$b;)V
...
.method public a(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lqp;->a(II)V
...
.method public a(Lnw;Landroid/support/v7/widget/ActionMenuPresenter;)V
    .locals 3
    ...
    invoke-virtual {p1, p2, v0}, Lnw;->a(Loe;Landroid/content/Context;)V
    ...
    invoke-virtual {p1, v0, v1}, Lnw;->a(Loe;Landroid/content/Context;)V

    goto :goto_0

    .line 570
    :cond_4
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->m:Landroid/content/Context;

    const/4 v1, 0x0

    invoke-virtual {p2, p1, v1}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/content/Context;Lnw;)V

    .line 571
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->L:Landroid/support/v7/widget/Toolbar$a;

    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->m:Landroid/content/Context;

    invoke-virtual {p1, v2, v1}, Landroid/support/v7/widget/Toolbar$a;->a(Landroid/content/Context;Lnw;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/Toolbar$a;->a(Z)V

    .line 575
    :goto_0
    iget-object p1, p0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
...
.method public a(Loe$a;Lnw$a;)V
    ...
    .line 2159
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->M:Loe$a;

    .line 2160
    iput-object p2, p0, Landroid/support/v7/widget/Toolbar;->N:Lnw$a;
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/ActionMenuView;->a(Loe$a;Lnw$a;)V
...
.method public b(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lqp;->b(II)V
...
.method public getCurrentContentInsetEnd()I
    ...
    .line 1322
    invoke-virtual {v0}, Lnw;->hasVisibleItems()Z
...
.method public getWrapper()Lpr;
    .locals 2

    .line 2110
    iget-object v0, p0, Landroid/support/v7/widget/Toolbar;->J:Lrc;
    ...
    invoke-direct {v0, p0, v1}, Lrc;-><init>(Landroid/support/v7/widget/Toolbar;Z)V

    iput-object v0, p0, Landroid/support/v7/widget/Toolbar;->J:Lrc;
...
.method public h()Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar$a;->b:Lnz;
...
.method public i()V
    ...
    .line 717
    invoke-virtual {v0}, Lnz;->collapseActionView()Z
...
.method l()V
    ...
    .line 2122
    iget v2, v2, Landroid/support/v7/widget/Toolbar$b;->e:I
    ...
    .line 2124
    iget-object v2, p0, Landroid/support/v7/widget/Toolbar;->G:Ljava/util/ArrayList;
...
.method m()V
    ...
    .line 2133
    iget-object v1, p0, Landroid/support/v7/widget/Toolbar;->G:Ljava/util/ArrayList;
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1490
    :cond_0
    iget-boolean v3, p0, Landroid/support/v7/widget/Toolbar;->E:Z
    ...
    .line 1493
    iput-boolean v4, p0, Landroid/support/v7/widget/Toolbar;->E:Z
...
.method protected onLayout(ZIIII)V
    ...
    .line 1718
    invoke-static/range {p0 .. p0}, Ljd;->k(Landroid/view/View;)I
    ...
    .line 1721
    :goto_1
    iget-object v13, v0, Landroid/support/v7/widget/Toolbar;->i:Landroid/widget/ImageButton;
    ...
    :cond_5
    :goto_4
    iget-object v15, v0, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    :cond_9
    :goto_6
    iget-object v13, v0, Landroid/support/v7/widget/Toolbar;->j:Landroid/widget/ImageView;
    ...
    .line 1779
    iget-object v14, v0, Landroid/support/v7/widget/Toolbar;->h:Landroid/widget/TextView;
    ...
    iget-object v15, v0, Landroid/support/v7/widget/Toolbar;->h:Landroid/widget/TextView;
    ...
    iget v2, v0, Landroid/support/v7/widget/Toolbar;->u:I
    ...
    .line 1871
    iget-object v6, v0, Landroid/support/v7/widget/Toolbar;->h:Landroid/widget/TextView;
    ...
    :cond_21
    :goto_17
    iget-object v1, v0, Landroid/support/v7/widget/Toolbar;->F:Ljava/util/ArrayList;
...
.method protected onMeasure(II)V
    ...
    iget v6, v7, Landroid/support/v7/widget/Toolbar;->q:I
    ...
    .line 1614
    iget-object v0, v7, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 1615
    iget-object v1, v7, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    iget-object v2, v7, Landroid/support/v7/widget/Toolbar;->f:Landroid/support/v7/widget/ActionMenuView;
    ...
    .line 1637
    :cond_4
    iget-object v0, v7, Landroid/support/v7/widget/Toolbar;->j:Landroid/widget/ImageView;
    ...
    .line 1638
    iget-object v1, v7, Landroid/support/v7/widget/Toolbar;->j:Landroid/widget/ImageView;
    ...
    iget-object v2, v7, Landroid/support/v7/widget/Toolbar;->g:Landroid/widget/TextView;
    ...
    .line 1673
    :goto_4
    iget-object v0, v7, Landroid/support/v7/widget/Toolbar;->h:Landroid/widget/TextView;
    ...
    .line 1674
    iget-object v1, v7, Landroid/support/v7/widget/Toolbar;->h:Landroid/widget/TextView;
    ...
    .line 1699
    invoke-direct/range {p0 .. p0}, Landroid/support/v7/widget/Toolbar;->s()Z
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/Toolbar$a;->b:Lnz;
    ...
    invoke-virtual {v1}, Lnz;->getItemId()I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1466
    :cond_0
    iget-boolean v2, p0, Landroid/support/v7/widget/Toolbar;->D:Z
...
.method public setPopupTheme(I)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/Toolbar;->m:Landroid/content/Context;
...
.method public setSubtitle(Ljava/lang/CharSequence;)V
    ...
    invoke-direct {v1, v0}, Lpn;-><init>(Landroid/content/Context;)V
