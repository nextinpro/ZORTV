...
.field private j:Landroid/support/v7/widget/RecyclerView$v;
...
.method public constructor <init>(Landroid/support/v7/widget/RecyclerView;)V
    ...
    .line 5533
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$p;->h:Ljava/util/List;

    const/4 p1, 0x2

    .line 5542
    iput p1, p0, Landroid/support/v7/widget/RecyclerView$p;->i:I
...
.method private a(Landroid/support/v7/widget/RecyclerView$x;IIJ)Z
    ...
    .line 5639
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iput-object v0, p1, Landroid/support/v7/widget/RecyclerView$x;->C:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 5647
    :cond_0
    iget-object p4, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object p4, p4, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$a;

    invoke-virtual {p4, p1, p2}, Landroid/support/v7/widget/RecyclerView$a;->b(Landroid/support/v7/widget/RecyclerView$x;I)V

    .line 5648
    iget-object p2, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v7/widget/RecyclerView$u;
...
.method private e(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    .line 5935
    invoke-static {v0}, Ljd;->d(Landroid/view/View;)I
    ...
    .line 5937
    invoke-static {v0, v1}, Ljd;->a(Landroid/view/View;I)V

    .line 5940
    :cond_0
    invoke-static {v0}, Ljd;->a(Landroid/view/View;)Z
    ...
    .line 5942
    iget-object p1, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object p1, p1, Landroid/support/v7/widget/RecyclerView;->ai:Lqn;

    .line 5943
    invoke-virtual {p1}, Lqn;->c()Lin;

    move-result-object p1

    .line 5942
    invoke-static {v0, p1}, Ljd;->a(Landroid/view/View;Lin;)V
...
# virtual methods
.method public final a(IZJ)Landroid/support/v7/widget/RecyclerView$x;
    .locals 17
    ...
    .line 5776
    iget-object v1, v6, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 5797
    invoke-virtual {v1, v5}, Landroid/support/v7/widget/RecyclerView$x;->b(I)V

    .line 5798
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->j()Z
    ...
    .line 5799
    iget-object v5, v6, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v9, v1, Landroid/support/v7/widget/RecyclerView$x;->b:Landroid/view/View;

    invoke-virtual {v5, v9, v8}, Landroid/support/v7/widget/RecyclerView;->removeDetachedView(Landroid/view/View;Z)V

    .line 5800
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->k()V

    goto :goto_1

    .line 5801
    :cond_3
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->l()Z
    ...
    .line 5802
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->m()V
    ...
    iget-object v5, v5, Landroid/support/v7/widget/RecyclerView;->z:Loq;

    invoke-virtual {v5, v3}, Loq;->b(I)I
    ...
    .line 5814
    iget-object v9, v6, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v9, v9, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$a;
    ...
    .line 5822
    iget-object v10, v6, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v10, v10, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$a;
    ...
    .line 5827
    iput v5, v1, Landroid/support/v7/widget/RecyclerView$x;->d:I
    ...
    .line 5831
    iget-object v0, v6, Landroid/support/v7/widget/RecyclerView$p;->j:Landroid/support/v7/widget/RecyclerView$v;
    ...
    iget-object v2, v6, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {v0, v9}, Landroid/support/v7/widget/RecyclerView$o;->b(I)Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 5856
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->x()V
    ...
    .line 5863
    iget-object v0, v6, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$a;

    iget-object v5, v6, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    invoke-virtual {v2, v5, v9}, Landroid/support/v7/widget/RecyclerView$a;->b(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 5872
    iget-object v5, v2, Landroid/support/v7/widget/RecyclerView$x;->b:Landroid/view/View;

    invoke-static {v5}, Landroid/support/v7/widget/RecyclerView;->m(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView;
    ...
    iput-object v10, v2, Landroid/support/v7/widget/RecyclerView$x;->c:Ljava/lang/ref/WeakReference;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v7/widget/RecyclerView$u;

    .line 5817
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$u;->i()I
    ...
    .line 5890
    invoke-virtual {v10, v0}, Landroid/support/v7/widget/RecyclerView$x;->a(I)Z
    ...
    .line 5891
    invoke-virtual {v10, v8, v0}, Landroid/support/v7/widget/RecyclerView$x;->a(II)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->T:Landroid/support/v7/widget/RecyclerView$f;
    ...
    .line 5897
    invoke-virtual {v10}, Landroid/support/v7/widget/RecyclerView$x;->w()Ljava/util/List;

    move-result-object v4

    .line 5896
    invoke-virtual {v1, v2, v10, v0, v4}, Landroid/support/v7/widget/RecyclerView$f;->a(Landroid/support/v7/widget/RecyclerView$u;Landroid/support/v7/widget/RecyclerView$x;ILjava/util/List;)Landroid/support/v7/widget/RecyclerView$f$d;
    ...
    invoke-virtual {v1, v10, v0}, Landroid/support/v7/widget/RecyclerView;->a(Landroid/support/v7/widget/RecyclerView$x;Landroid/support/v7/widget/RecyclerView$f$d;)V
    ...
    .line 5905
    iput v3, v10, Landroid/support/v7/widget/RecyclerView$x;->h:I
    ...
    invoke-virtual {v0, v3}, Loq;->b(I)I
    ...
    .line 5916
    :goto_7
    iget-object v1, v10, Landroid/support/v7/widget/RecyclerView$x;->b:Landroid/view/View;
    ...
    .line 5920
    iget-object v2, v10, Landroid/support/v7/widget/RecyclerView$x;->b:Landroid/view/View;
    ...
    .line 5927
    :goto_8
    iput-object v10, v1, Landroid/support/v7/widget/RecyclerView$i;->i:Landroid/support/v7/widget/RecyclerView$x;
    ...
    .line 5928
    :goto_9
    iput-boolean v7, v1, Landroid/support/v7/widget/RecyclerView$i;->l:Z
...
.method final a(JIZ)Landroid/support/v7/widget/RecyclerView$x;
    .locals 6
    ...
    .line 6327
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$x;->i()I
    ...
    .line 6349
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/RecyclerView$p;->c(Landroid/view/View;)V
    ...
    .line 6359
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->h()J
...
.method final a(II)V
    ...
    .line 6407
    iget v7, v6, Landroid/support/v7/widget/RecyclerView$x;->d:I
...
.method final a(IIZ)V
    ...
    .line 6448
    iget v3, v2, Landroid/support/v7/widget/RecyclerView$x;->d:I
...
.method final a(Landroid/support/v7/widget/RecyclerView$a;Landroid/support/v7/widget/RecyclerView$a;Z)V
    .locals 1
...
.method final a(Landroid/support/v7/widget/RecyclerView$o;)V
    .locals 1
...
.method final a(Landroid/support/v7/widget/RecyclerView$v;)V
    ...
    .line 6465
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$p;->j:Landroid/support/v7/widget/RecyclerView$v;
...
.method public final a(Landroid/support/v7/widget/RecyclerView$x;Z)V
    ...
    invoke-static {v0, v2}, Ljd;->a(Landroid/view/View;Lin;)V
    ...
    .line 6152
    :cond_1
    iput-object v2, p1, Landroid/support/v7/widget/RecyclerView$x;->C:Landroid/support/v7/widget/RecyclerView;
...
.method public final a(Landroid/view/View;)V
    ...
    .line 5990
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;
...
.method public final a(Landroid/view/View;I)V
    ...
    .line 5677
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView;->b()Ljava/lang/String;
    ...
    invoke-virtual {v0, p2}, Loq;->b(I)I
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$a;
    ...
    .line 5699
    iput-boolean v0, p2, Landroid/support/v7/widget/RecyclerView$i;->k:Z

    .line 5700
    iput-object p1, p2, Landroid/support/v7/widget/RecyclerView$i;->i:Landroid/support/v7/widget/RecyclerView$x;
    ...
    :goto_1
    iput-boolean v0, p2, Landroid/support/v7/widget/RecyclerView$i;->l:Z
    ...
    invoke-virtual {p2}, Landroid/support/v7/widget/RecyclerView;->b()Ljava/lang/String;
...
.method final a(Landroid/support/v7/widget/RecyclerView$x;)Z
    ...
    .line 5608
    :cond_0
    iget v0, p1, Landroid/support/v7/widget/RecyclerView$x;->d:I
...
.method public final b(I)I
    ...
    invoke-virtual {v0, p1}, Loq;->b(I)I
...
.method final b(IZ)Landroid/support/v7/widget/RecyclerView$x;
    .locals 5
    ...
    .line 6274
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$x;->l()Z
    ...
    iget-object v4, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->ae:Landroid/support/v7/widget/RecyclerView$u;

    iget-boolean v4, v4, Landroid/support/v7/widget/RecyclerView$u;->i:Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->A:Lpp;

    invoke-virtual {v0, p1}, Lpp;->c(I)Landroid/view/View;
    ...
    iget-object p2, p2, Landroid/support/v7/widget/RecyclerView;->A:Lpp;

    invoke-virtual {p2, v0}, Lpp;->e(Landroid/view/View;)V
    ...
    invoke-virtual {p2, v0}, Lpp;->b(Landroid/view/View;)I
    ...
    invoke-virtual {v1, p2}, Lpp;->e(I)V

    .line 6294
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/RecyclerView$p;->d(Landroid/view/View;)V

    const/16 p2, 0x2020

    .line 6295
    invoke-virtual {p1, p2}, Landroid/support/v7/widget/RecyclerView$x;->b(I)V
    ...
    .line 6307
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->p()Z

    move-result v3

    if-nez v3, :cond_6

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$x;->e()I
...
.method public final b()V
    ...
    iget v0, v0, Landroid/support/v7/widget/RecyclerView$LayoutManager;->Q:I
    ...
    .line 5572
    :goto_0
    iget v1, p0, Landroid/support/v7/widget/RecyclerView$p;->i:I
...
.method final b(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    .line 6070
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->G:Landroid/support/v7/widget/RecyclerView$a;
    ...
    .line 6072
    invoke-virtual {v3, p1}, Landroid/support/v7/widget/RecyclerView$a;->c(Landroid/support/v7/widget/RecyclerView$x;)Z
    ...
    .line 6095
    invoke-virtual {v4, v5}, Lpz$a;->a(I)Z
    ...
    iget v4, v4, Landroid/support/v7/widget/RecyclerView$x;->d:I

    .line 6100
    iget-object v5, p0, Landroid/support/v7/widget/RecyclerView$p;->g:Landroid/support/v7/widget/RecyclerView;

    iget-object v5, v5, Landroid/support/v7/widget/RecyclerView;->ad:Lpz$a;

    invoke-virtual {v5, v4}, Lpz$a;->a(I)Z
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->B:Lri;

    invoke-virtual {v2, p1}, Lri;->g(Landroid/support/v7/widget/RecyclerView$x;)V
...
.method public final c()Ljava/util/List;
    ...
    .line 5587
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$p;->h:Ljava/util/List;
...
.method final c(II)V
    ...
    .line 6494
    iget v2, v1, Landroid/support/v7/widget/RecyclerView$x;->d:I
    ...
    .line 6496
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/RecyclerView$x;->b(I)V
...
.method final c(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    .line 6212
    invoke-virtual {p1}, Landroid/support/v7/widget/RecyclerView$x;->m()V
...
.method final d()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->ad:Lpz$a;

    invoke-virtual {v0}, Lpz$a;->a()V
...
.method final d(Landroid/support/v7/widget/RecyclerView$x;)V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->I:Landroid/support/v7/widget/RecyclerView$q;
...
.method final f(I)Landroid/support/v7/widget/RecyclerView$x;
    .locals 9
    ...
    .line 6239
    invoke-virtual {v5}, Landroid/support/v7/widget/RecyclerView$x;->l()Z

    move-result v6

    if-nez v6, :cond_1

    invoke-virtual {v5}, Landroid/support/v7/widget/RecyclerView$x;->e()I
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->z:Loq;

    invoke-virtual {v3, p1}, Loq;->b(I)I
...
.method final g()Landroid/support/v7/widget/RecyclerView$o;
    .locals 1
...
.method final i()V
    ...
    .line 6524
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$x;->a()V
