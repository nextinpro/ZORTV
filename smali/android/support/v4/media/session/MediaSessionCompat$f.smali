...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->F:Lhb$a;
...
.method public final a(I)V
    ...
    .line 1898
    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->w:Lhb;
    ...
    invoke-virtual {p1, v0}, Lhb;->a(Lhb$a;)V
    ...
    iget v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->u:I

    iget v2, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->v:I

    const/4 v3, 0x2

    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->c:Landroid/media/AudioManager;

    iget v4, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->v:I
...
.method final a(II)V
    ...
    .line 2282
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->w:Lhb;
    ...
    invoke-virtual {p2, p1}, Lhb;->c(I)V
...
.method public final a(Landroid/support/v4/media/MediaMetadataCompat;)V
    ...
    .line 7354
    :try_start_1
    invoke-interface {v1, p1}, Lhd;->a(Landroid/support/v4/media/MediaMetadataCompat;)V
    :try_end_1
...
.method final a(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    ...
    .line 2305
    :try_start_0
    invoke-interface {v1, p1}, Lhd;->a(Landroid/support/v4/media/session/ParcelableVolumeInfo;)V
    :try_end_0
...
.method public final a(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 5342
    :try_start_1
    invoke-interface {v1, p1}, Lhd;->a(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
...
.method public final a(Lhb;)V
    ...
    .line 1914
    :cond_0
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->w:Lhb;
    ...
    invoke-virtual {v0, v1}, Lhb;->a(Lhb$a;)V
    ...
    .line 1918
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->w:Lhb;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->w:Lhb;
    ...
    .line 1924
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$f;->F:Lhb$a;
...
.method b(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    .line 1993
    invoke-static {p1}, Landroid/support/v4/media/session/MediaSessionCompat$f;->b(I)I
