...
.method public static parse(Landroid/os/Bundle;)Ltv/danmaku/ijk/media/player/IjkMediaMeta;
    ...
    .line 205
    invoke-virtual {v0, p0, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 206
    invoke-virtual {v0, v2, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 207
    invoke-virtual {v0, v3, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I

    const-string v3, "streams"

    .line 210
    invoke-virtual {v0, v3}, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-direct {v5, v1}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;-><init>(I)V
    ...
    .line 224
    invoke-virtual {v5, v4}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iput-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    .line 226
    iget-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;

    const-string v4, "codec_long_name"
    ...
    iput-object v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    const-string v4, "bitrate"

    .line 234
    invoke-virtual {v5, v4}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v4

    int-to-long v6, v4

    iput-wide v6, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mWidth:I
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mHeight:I

    const-string v4, "fps_num"
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsNum:I

    const-string v4, "fps_den"
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsDen:I

    const-string v4, "tbr_num"
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrNum:I

    const-string v4, "tbr_den"
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarDen:I

    if-ne p0, v1, :cond_4

    .line 247
    iput-object v5, v0, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mVideoStream:Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
    ...
    iput v4, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSampleRate:I

    const-string v4, "channel_layout"

    .line 253
    invoke-virtual {v5, v4}, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v6

    iput-wide v6, v5, Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mChannelLayout:J

    if-ne v2, v1, :cond_4

    .line 256
    iput-object v5, v0, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mAudioStream:Ltv/danmaku/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    .line 259
    :cond_4
    :goto_1
    iget-object v4, v0, Ltv/danmaku/ijk/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;
