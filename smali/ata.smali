...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lata;->zzbt:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lata;->zzbu:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static cancelAvailabilityErrorNotifications(Landroid/content/Context;)V
    ...
    sget-object v0, Lata;->zzbt:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static enableUsingApkIndependentContext()V
    ...
    sget-object v0, Lata;->zzbu:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static ensurePlayServicesAvailable(Landroid/content/Context;)V
    ...
    invoke-static {p0, v0}, Lata;->ensurePlayServicesAvailable(Landroid/content/Context;I)V
...
.method public static ensurePlayServicesAvailable(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, p0, p1}, Lasv;->b(Landroid/content/Context;I)I
    ...
    invoke-virtual {v0, p0, p1, v1}, Lasv;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {p0, p1}, Lasy;-><init>(I)V
    ...
    invoke-direct {v0, p1, v1, p0}, Lasz;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static getClientVersion(Landroid/content/Context;)I
    ...
    .line 3000
    invoke-static {p0, v0}, Laxz;->a(Landroid/content/Context;Ljava/lang/String;)Landroid/content/pm/PackageInfo;
...
.method public static getErrorPendingIntent(ILandroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v0, p1, p0, p2}, Lasv;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method public static getGooglePlayServicesAvailabilityRecoveryIntent(I)Landroid/content/Intent;
    ...
    invoke-virtual {v0, v1, p0, v1}, Lasv;->a(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
...
.method public static honorsDebugCertificates(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lata;->isTestKeysBuild(Landroid/content/Context;)Z

    move-result p0

    if-nez p0, :cond_1

    invoke-static {}, Lata;->isUserBuildDevice()Z
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;)I
    ...
    invoke-static {p0, v0}, Lata;->isGooglePlayServicesAvailable(Landroid/content/Context;I)I
...
.method public static isGooglePlayServicesAvailable(Landroid/content/Context;I)I
    ...
    sget v1, Latc$a;->common_google_play_services_unknown_issue:I
    ...
    invoke-static {p0}, Lawm;->b(Landroid/content/Context;)I
    ...
    :cond_0
    sget v1, Lata;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I

    if-eq v0, v1, :cond_1

    new-instance p0, Ljava/lang/IllegalStateException;

    sget p1, Lata;->GOOGLE_PLAY_SERVICES_VERSION_CODE:I
    ...
    :cond_1
    invoke-static {p0}, Layc;->b(Landroid/content/Context;)Z
    ...
    .line 1000
    sget-object v0, Layc;->a:Ljava/lang/Boolean;
    ...
    sput-object v0, Layc;->a:Ljava/lang/Boolean;
    ...
    :goto_3
    invoke-static {p0, v1, p1}, Lata;->zza(Landroid/content/Context;ZI)I
...
.method public static isGooglePlayServicesUid(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Layo;->a(Landroid/content/Context;I)Z
...
.method public static isPlayServicesPossiblyUpdating(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lata;->isUninstalledAppPossiblyUpdating(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static isTestKeysBuild(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Latb;->a(Landroid/content/Context;)Latb;

    const/4 p0, 0x0

    if-eqz v1, :cond_0

    invoke-static {v1, p0}, Latb;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result v2

    if-nez v2, :cond_0

    invoke-static {v1, v0}, Latb;->a(Landroid/content/pm/PackageInfo;Z)Z

    move-result v1

    if-eqz v1, :cond_0

    sput-boolean v0, Lata;->zzbr:Z

    goto :goto_0

    :cond_0
    sput-boolean p0, Lata;->zzbr:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static isUninstalledAppPossiblyUpdating(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lata;->isRestrictedUserProfile(Landroid/content/Context;)Z
...
.method public static isUserBuildDevice()Z
    ...
    .line 2000
    sget-boolean v0, Lata;->sIsTestMode:Z

    if-eqz v0, :cond_0

    sget-boolean v0, Lata;->sTestIsUserBuild:Z
...
.method public static uidHasPackageName(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Layo;->a(Landroid/content/Context;ILjava/lang/String;)Z
...
.method private static zza(Landroid/content/Context;ZI)I
    ...
    invoke-static {v5, v1}, Latb;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {v3, v1}, Latb;->a(Landroid/content/pm/PackageInfo;Z)Z
    ...
    invoke-static {p0}, Laye;->a(I)I

    move-result p0

    invoke-static {p2}, Laye;->a(I)I
