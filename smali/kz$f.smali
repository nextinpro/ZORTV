...
# direct methods
.method public constructor <init>(Lkz;Landroid/content/Context;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1279
    invoke-static {p2}, Lle;->c(Landroid/content/Context;)F

    move-result p1

    iput p1, p0, Lkz$f;->a:F
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    sget v1, Lmq$j;->mr_controller_volume_item:I
    ...
    .line 1294
    :cond_0
    iget-object v1, p0, Lkz$f;->b:Lkz;

    invoke-virtual {v1, p2}, Lkz;->c(Landroid/view/View;)V

    .line 1297
    :goto_0
    invoke-virtual {p0, p1}, Lkz$f;->getItem(I)Ljava/lang/Object;
    ...
    .line 1305
    sget v2, Lmq$g;->mr_volume_slider:I
    ...
    iget-object v3, p0, Lkz$f;->b:Lkz;

    iget-object v3, v3, Lkz;->n:Landroid/support/v7/app/OverlayListView;

    .line 1307
    invoke-static {p3, v2, v3}, Lle;->a(Landroid/content/Context;Landroid/support/v7/app/MediaRouteVolumeSlider;Landroid/view/View;)V

    .line 1309
    invoke-virtual {v2, p1}, Landroid/support/v7/app/MediaRouteVolumeSlider;->setTag(Ljava/lang/Object;)V

    .line 1310
    iget-object p3, p0, Lkz$f;->b:Lkz;

    iget-object p3, p3, Lkz;->u:Ljava/util/Map;
    ...
    .line 1311
    invoke-virtual {v2, p3}, Landroid/support/v7/app/MediaRouteVolumeSlider;->a(Z)V
    ...
    invoke-virtual {p3, p1}, Lkz;->a(Lmf$h;)Z
    ...
    :cond_2
    :goto_1
    sget p3, Lmq$g;->mr_volume_item_icon:I
    ...
    .line 1331
    sget p3, Lmq$g;->volume_item_container:I
    ...
    iget-object v1, v1, Lkz;->q:Ljava/util/Set;
    ...
    iget-object p3, p3, Lkz;->p:Ljava/util/Set;
