...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 96
    iput-object p1, p0, Lbu;->a:Ljava/io/File;

    .line 97
    iput-object p2, p0, Lbu;->c:Ljava/io/File;

    .line 98
    invoke-static {p1}, Lbu;->b(Ljava/io/File;)J

    move-result-wide v0

    iput-wide v0, p0, Lbu;->b:J
    ...
    iput-object p2, p0, Lbu;->d:Ljava/io/RandomAccessFile;

    .line 102
    :try_start_0
    iget-object p2, p0, Lbu;->d:Ljava/io/RandomAccessFile;

    invoke-virtual {p2}, Ljava/io/RandomAccessFile;->getChannel()Ljava/nio/channels/FileChannel;

    move-result-object p2

    iput-object p2, p0, Lbu;->e:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    .line 105
    iget-object p2, p0, Lbu;->e:Ljava/nio/channels/FileChannel;

    invoke-virtual {p2}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;

    move-result-object p2

    iput-object p2, p0, Lbu;->f:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    invoke-static {p2}, Lbu;->a(Ljava/io/Closeable;)V
...
.method private a()Ljava/util/List;
    ...
    iget-object v1, p0, Lbu;->a:Ljava/io/File;
    ...
    iget-object v3, p0, Lbu;->a:Ljava/io/File;
    ...
    iget-object v7, p0, Lbu;->c:Ljava/io/File;

    invoke-direct {v6, v7, v5}, Lbu$a;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    .line 272
    invoke-static {v2, v4, v6, v0}, Lbu;->a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 276
    :try_start_1
    invoke-static {v6}, Lbu;->b(Ljava/io/File;)J

    move-result-wide v8

    iput-wide v8, v6, Lbu$a;->crc:J
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    invoke-virtual {v6}, Lbu$a;->getAbsolutePath()Ljava/lang/String;
    ...
    .line 286
    invoke-virtual {v6}, Lbu$a;->length()J
    ...
    .line 289
    invoke-virtual {v6}, Lbu$a;->delete()Z

    .line 290
    invoke-virtual {v6}, Lbu$a;->exists()Z
    ...
    .line 292
    invoke-virtual {v6}, Lbu$a;->getPath()Ljava/lang/String;
...
.method private a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Lbu;->a:Ljava/io/File;
    ...
    .line 179
    invoke-static/range {p1 .. p1}, Lbu;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    .line 185
    new-instance v8, Lbu$a;

    iget-object v9, v0, Lbu;->c:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Lbu$a;-><init>(Ljava/io/File;Ljava/lang/String;)V

    .line 186
    invoke-virtual {v8}, Lbu$a;->isFile()Z
    ...
    .line 187
    invoke-static {v8}, Lbu;->b(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Lbu$a;->crc:J
    ...
    .line 192
    invoke-virtual {v8}, Lbu$a;->lastModified()J
    ...
    .line 204
    invoke-virtual {v8}, Lbu$a;->getPath()Ljava/lang/String;
...
.method private static a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    .line 321
    invoke-static {p0}, Lbu;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-virtual {p4}, Lbu$a;->lastModified()J
...
.method private static a(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    .line 412
    :cond_2
    invoke-static {p0}, Lbu;->a(Ljava/io/Closeable;)V
...
.method private static b(Ljava/io/File;)J
    ...
    .line 234
    invoke-static {p0}, Lbv;->a(Ljava/io/File;)J
...
.method private b()V
    ...
    .line 354
    iget-object v0, p0, Lbu;->c:Ljava/io/File;

    new-instance v1, Lbu$1;

    invoke-direct {v1, p0}, Lbu$1;-><init>(Lbu;)V
    ...
    iget-object v2, p0, Lbu;->c:Ljava/io/File;
...
.method final a(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v2, p0, Lbu;->a:Ljava/io/File;
    ...
    .line 131
    iget-object v0, p0, Lbu;->f:Ljava/nio/channels/FileLock;
    ...
    .line 136
    iget-object v0, p0, Lbu;->a:Ljava/io/File;

    iget-wide v1, p0, Lbu;->b:J

    .line 1218
    invoke-static {p1}, Lbu;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {v0}, Lbu;->a(Ljava/io/File;)J
    ...
    .line 138
    :try_start_0
    invoke-direct {p0, p1, p2}, Lbu;->a(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 152
    :goto_2
    invoke-direct {p0}, Lbu;->a()Ljava/util/List;
    ...
    invoke-static/range {v1 .. v7}, Lbu;->a(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
...
.method public final close()V
    ...
    .line 164
    iget-object v0, p0, Lbu;->e:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    .line 165
    iget-object v0, p0, Lbu;->d:Ljava/io/RandomAccessFile;
